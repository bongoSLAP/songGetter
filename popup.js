function fetchVideoDataFromContent() {
...
function sendUrlToBackground(urlObject) {
    console.log('sendUrl: ', urlObject);
    let url = "";
...
window.addEventListener('load', function() {
    fetchVideoDataFromContent().then(function(urlObject) {
        console.log('url: ', urlObject);
        document.querySelector('#get-song-button').addEventListener('click', function() {sendUrlToBackground(urlObject)});
        document.querySelector('#get-playlist-button').addEventListener('click', function() {sendUrlToBackground(urlObject)});
